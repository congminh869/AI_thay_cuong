...
def ContainerMain(name,source, out):
...
class ContainerThread (threading.Thread):
   ...
   def run(self):
      ...
      ContainerMain(self.name, self.source, self.out)
...
thread2 = ContainerThread("ContainerThread2", 'rtsp://admin:123@123a@192.168.6.32:554/cam/realmonitor?channel=1&subtype=0', "out2.jpg")
thread3 = ContainerThread("ContainerThread3", 'rtsp://admin:123@123a@192.168.6.32:554/cam/realmonitor?channel=1&subtype=0', "out3.jpg")
thread4 = ContainerThread("ContainerThread4",'rtsp://admin:123@123a@192.168.6.32:554/cam/realmonitor?channel=1&subtype=0', "out4.jpg")
# Start new Threads
thread1.start()
thread2.start()
thread3.start()
